        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApiKey1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAvailableForPaidUsers = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatbotModels", x => x.ModelId);
                    table.ForeignKey(
                        name: "FK_ChatbotModels_ApiKeys_ApiKeyId",
                        column: x => x.ApiKeyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UsageLogID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserID = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ChatbotModelID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UsageLogs_ChatbotModels_ChatbotModelID",
                        column: x => x.ChatbotModelID,
                        principalTable: "ChatbotModels",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ModifiedMessageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MessageId = table.Column<int>(type: "int", nullable: true),
                    UserModifiedMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModifiedMessages", x => x.ModifiedMessageId);
                    table.ForeignKey(
                        name: "FK_ModifiedMessages_Messages_MessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatbotModels_ApiKeyId",
                table: "ChatbotModels",
                column: "ApiKeyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModifiedMessages_MessageId",
                table: "ModifiedMessages",
                column: "MessageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsageLogs_ChatbotModelID",
                table: "UsageLogs",
                column: "ChatbotModelID");
